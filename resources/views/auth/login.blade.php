...
<div class="row mb-4 align-items-center flex-lg-row-reverse">
    ...
    <div class="col-md-6 col-xl-5">
        <div class="lc-block mb-3">
            <div editable="rich">
                <h5 class="fw-bolder display-5"><strong>AMS - Asset Management System</strong> <i class="fa fa-pen" aria-hidden="true"></i></h5>
            </div>
        </div>
        <div class="lc-block mb-4">
            <div editable="rich">
                <p class="lead">
                  Asset Management System (AMS) is a comprehensive approach to managing and optimizing the lifecycle of assets within an organization. 
                  Assets can include physical items such as equipment, machinery, vehicles, and infrastructure, as well as intangible assets like software, licenses, and intellectual property. 
                  The primary goal of an Asset Management System is to enable organizations to make informed decisions regarding the acquisition, use, maintenance, and disposal of assets to maximize their value and minimize costs and risks.
                </p>
            </div>
        </div>
        <div class="lc-block">
