...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar bg-primary sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item @yield('active-page-asset')">
                ...
                <div id="collapseAsset" class="collapse" aria-labelledby="headingAsset" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/asset/laptop">Laptop Asset</a>
                        <a class="collapse-item" href="/asset/card">Card Asset</a>
                        <a class="collapse-item" href="/asset/email">Email Asset</a>
                    </div>
                </div>
            </li>    
           <li class="nav-item @yield('active-page-holder')">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/manage/holder">Manage Holder</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
