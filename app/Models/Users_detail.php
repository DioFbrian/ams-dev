...
class Users_detail extends Model
{
    ...
    protected $fillable = [
        'user_id', 'status_active', 'employee_status', 'resignation_date', 'hired_date', 'position_id', 'department_id',
        ...
        'usr_gender', 'usr_religion', 'usr_merital_status', 'usr_children', 'usr_bank_name', 'usr_bank_branch', 'usr_bank_account', 'profile_pic', 'cv'
    ];
